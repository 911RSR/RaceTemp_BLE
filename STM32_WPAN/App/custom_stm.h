...
typedef enum
{
  /* RaceChrono */
  CUSTOM_STM_CAN_MAIN,
  CUSTOM_STM_CAN_FILTER,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* CAN_main */
  CUSTOM_STM_CAN_MAIN_READ_EVT,
  CUSTOM_STM_CAN_MAIN_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_CAN_MAIN_NOTIFY_DISABLED_EVT,
  /* CAN_filter */
  CUSTOM_STM_CAN_FILTER_WRITE_EVT,
...
extern uint16_t SizeCan_Filter;
