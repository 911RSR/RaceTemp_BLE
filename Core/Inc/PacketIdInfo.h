 ...
 * PackedIdInfo.h
 *
 * from GitHub aollin / racechrono-ble-diy-device
 *
 */
...
static const unsigned int MAP_MAX_ITEMS = 1024;
static const unsigned int MAP_HASH_BITS = 1;
static const unsigned int MAP_HASH_SIZE = 1 << MAP_HASH_BITS;
static const unsigned int MAP_HASH_BITMASK = MAP_HASH_SIZE - 1;
