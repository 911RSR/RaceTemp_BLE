...
const static struct NTC_t NTC_KOSO = { 50000.0, 25.0 + 273.15, 4000.0, 1000.0 }; // 1 kOhm -- same as the other
//const static struct NTC_t NTC_KOSO = { 50000.0, 25.0 + 273.15, 4000.0, 10000.0 };  // 10k for better accuracy
